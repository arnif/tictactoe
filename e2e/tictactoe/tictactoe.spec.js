...
describe('TicTacToe Create View', function() {
  ...
  it('should play a game of TicTacToe and X will win (row)', function() {
  ...
  it('should play a game of TicTacToe and end with draw', function() {
      ...
      browser.getAllWindowHandles().then(function (handles) {
        ...
        browser.driver.wait(function(){
          ...
          then(function(){
            ...
            play.expectGameMessage('Game OVER! - Winner: Draw!');
